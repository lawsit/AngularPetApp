...
describe('Pet Component - Admin Access', () => {
  ...
  it('Test - Create Button is enabled', async(() => {
    // given
    const compiled = fixture.debugElement.nativeElement;
    ...
    fixture.whenStable().then(() => {
      ...
      let newBtn = fixture.debugElement.query(By.css('.new_btn')).nativeElement;
  ...
  it('Test - Edit Button is shown', async(() => {
    // given
    const compiled = fixture.debugElement.nativeElement;
